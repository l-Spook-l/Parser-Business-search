...
# =====================================TEST================================================
# =========================================================================================
# response = requests.get(url=f"http://{city_1}.ukr-prom.com/?page={page}")
# page += 1
# # print(response.text)
# src = response.text
# soup = BeautifulSoup(src, "lxml")
...
# for address in list_company_address:
#     with open('test_address_company.txt', "a") as file:
#         file.write(' '.join(address) + '\n')
#         print(' '.join(address))

# print(list_company_address)
